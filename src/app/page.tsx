      ...
      <div className="landing-page">
        ...
        <section id="math">
          ...
          <div className="econ-row">
            <div className="econ-card a"><div className="label">Frame Shift Engagement Engine</div><div className="number">$6,500</div><div className="detail">/month — handles 5–7K messages/day, 24/7, no sick days, no Saturday overtime</div></div>
